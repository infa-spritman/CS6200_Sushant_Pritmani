 ...
 */
public class UnigramLapalce {

    public static void runULP(String queryPath, String reportPath, String indexName, String type) {
        ...
        for (String term : queryTerms) {
            ...
            try {
                ...
                SearchResponse scrollResp = client.prepareSearch("ap_dataset")
                        ...
                        .addScriptField("ULP", new Script(ScriptType.INLINE, "groovy",
                                "int d = doc['doclength'].value; double tf = _index['text'][\"" + term + "\"].tf(); double df = _index['text'][\"" + term + "\"].df(); return Math.log10((tf+1)/(d+178081.0));",
                ...
                do {
                    for (SearchHit hit : scrollResp.getHits().getHits()) {
                        ...
                        double score = Double.parseDouble(hit.getFields().get("ULP").getValues().get(0).toString());
